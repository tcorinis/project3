...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(WINDOW_WIDTH, WINDOW_HEIGHT), "Song Searcher", sf::Style::Titlebar | sf::Style::Close);
    ...
    if (!logoTexture.loadFromFile("assets/MWLogo.png"))
    {
