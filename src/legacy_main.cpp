...
int main()
{
	...
	{
		std::cout << allSongs[allLyrics.at(i).artistName][allLyrics.at(i).songTitle].at(allLyrics.at(i).positionIndex) << std::endl;
		std::cout << allSongs[allLyrics.at(i).artistName][allLyrics.at(i).songTitle].at((allLyrics.at(i).positionIndex + 1)) << std::endl;
		std::cout << allSongs[allLyrics.at(i).artistName][allLyrics.at(i).songTitle].at((allLyrics.at(i).positionIndex - 1)) << std::endl;
